    ...
    (match (map-get? pox-addr-indices reward-cycle)
      ...
      index 
        (begin
          ...
          (match (as-contract (contract-call? .pox-4-mock stack-aggregation-increase (var-get pool-pox-address) reward-cycle index (some (var-get pox-signer-signature)) (var-get pox-signer-key) u999999999000000 u1))
            success 
              (begin
